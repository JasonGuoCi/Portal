...
namespace Envision.SPS.Utility.Utilities
{
    public class IBUtils
    {
        ...
        #region 获得配置文件节点XML文件的绝对路径
        public static string GetXmlMapPathConfig(string xmlName)
        {
        ...
        /// <returns></returns>
        public static string WebOutPageList(int pageSize, int pageIndex, int totalCount, string linkUrl, int centSize)
        {
            //计算页数
            ...
            string firstBtn = "<td><a href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex - 1).ToString()) + "\">上一页</a></td>";
            string lastBtn = "<td><a href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex + 1).ToString()) + "\">下一页</a></td>";
            string firstStr = "<td><a href=\"" + ReplaceStr(linkUrl, pageId, "1") + "\">1</a></td>";
            string lastStr = "<td><a href=\"" + ReplaceStr(linkUrl, pageId, pageCount.ToString()) + "\">" + pageCount.ToString() + "</a></td>";

            if (pageIndex <= 1)
            {
                firstBtn = "<td><span class=\"disabled\">上一页</span></td>";
            }
            if (pageIndex >= pageCount)
            {
                lastBtn = "<td><span class=\"disabled\">下一页</span></td>";
            }
            if (pageIndex == 1)
            {
                firstStr = "<td><span class=\"page_hover\">1</span></td>";
            }
            if (pageIndex == pageCount)
            {
                lastStr = "<td><span class=\"page_hover\">" + pageCount.ToString() + "</span></td>";
            }
            ...
            if (pageIndex >= centSize)
            {
                pageStr.Append("<td><span>...</span>\n</td>");
            }
            for (int i = firstNum; i <= lastNum; i++)
            {
                if (i == pageIndex)
                {
                    pageStr.Append("<td><span class=\"page_hover\">" + i + "</span></td>");
                }
                else
                {
                    pageStr.Append("<td><a class=\"page\" href=\"" + ReplaceStr(linkUrl, pageId, i.ToString()) + "\">" + i + "</a></td>");
                }
            }
            if (pageCount - pageIndex > centSize - ((centSize / 2)))
            {
                pageStr.Append("<td><span>...</span></td>");
            }
        ...
        //    if (lastNum >= pageCount)
        //        lastNum = pageCount - 1;
        //    //pageStr.Append("<span>Total:" + totalCount + "</span>");
        //    pageStr.Append(firstBtn + firstStr);
        //    if (pageIndex >= centSize)
        //    {
        ...
        public static string OutPageList(int pageSize, int pageIndex, int totalCount, string linkUrl, int centSize)
        {
            ...
            if (totalCount < 1 || pageSize < 1)
            {
                return "<span class=\"disabled\">«上一页</span><a>1</a><span class=\"disabled\">上一页»</span>";
            }
            int pageCount = totalCount / pageSize;
            if (pageCount < 1)
            {
                return "<span class=\"disabled\">«上一页</span><a>1</a><span class=\"disabled\">下一页»</span>";
            }
            if (totalCount % pageSize > 0)
            {
                pageCount += 1;
        ...
        public static string OutPageListAjax(int pageSize, int pageIndex, int totalCount, string keywords,int category, int centSize)
        {
            //计算页数
            if (totalCount < 1 || pageSize < 1)
            {
            ...
            string firstBtn = "<a style='cursor:pointer;' onclick='envdoc.methods.GroupsPages(" + (pageIndex - 1) + "," + category + ")'>«上一页</a>";
            string lastBtn = "<a style='cursor:pointer;' onclick='envdoc.methods.GroupsPages(" + (pageIndex + 1) + "," + category + ")'>下一页»</a>";
            string firstStr = "<a style='cursor:pointer;' onclick='envdoc.methods.GroupsPages(1," + category + ")'>1</a>";
            string lastStr = "<a style='cursor:pointer;' onclick='envdoc.methods.GroupsPages(" + pageCount + "," + category + ")'>" + pageCount.ToString() + "</a>";
            ...
            for (int i = firstNum; i <= lastNum; i++)
            {
                ...
                {
                    pageStr.Append("<a style='cursor:pointer;' onclick='envdoc.methods.GroupsPages(" + i + "," + category + ")'>" + i + "</a>");
                }
            }
            if (pageCount - pageIndex > centSize - ((centSize / 2)))
            {
        ...
        public static string GridItemStyle(string hidLayer)
        {
            string LitFirst = string.Empty;
            string LitStyle = "<span style=\"display:inline-block;width:{0}px;\"></span>{1}{2}";
            string LitImg1 = "<span class=\"folder-open\"></span>";
            string LitImg2 = "<span class=\"folder-line\"></span>";

            int classLayer = Convert.ToInt32(hidLayer);
            if (classLayer == 1)
            {
                LitFirst = LitImg1;
            }
            ...
            {
                LitFirst = string.Format(LitStyle, (classLayer - 2) * 24, LitImg2, LitImg1);
            }
            return LitFirst;
        }
        ...
        /// <returns></returns>
        public static string GetParamValue(string paramv)
        {
            string value = string.Empty;
            string[] param = HttpContext.Current.Request.UrlReferrer.Query.Replace("?", "").Split('&');
        ...
        /// <param name="paramv"></param>
        /// <returns></returns>
        public static int GetParamValueToInt(string paramv)
        {
            int parami = 0;
            if (int.TryParse(GetParamValue(paramv), out parami))
            {
        ...
        public static string Selected(string Property, string Value)
        {
            return (Property.ToUpper() == Value.ToUpper()) ? "selected=\"selected\"" : "";
        }

        public static string GetEmailSendStatus(string codeStatus)
        {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static string GetXiuSiDunDate(DateTime dt)
        {
            string Date = string.Empty;
            DateTime dt4 = TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time")).IsDaylightSavingTime() ? TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time")).AddHours(1) : TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time"));
            return ChangeMonth(dt4.Month) + " " + dt4.Day + ", " + dt4.Year + "  " + dt4.DayOfWeek;
        }
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static string GetXiuSiDunTime(DateTime dt)
        {
            string Date = string.Empty;

            DateTime dt4 = TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time")).IsDaylightSavingTime() ? TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time")).AddHours(1) : TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time"));
            return string.Format("{0:hh:mm tt}", dt4).Replace("上午", "AM").Replace("下午", "PM");
        }
        #endregion
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static string GetGuiGuDate(DateTime dt)
        {
            string Date = string.Empty;
            string TimeZoneId = "Pacific Standard Time";
            DateTime dt4 = TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId)).IsDaylightSavingTime() ? TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId)).AddHours(1) : TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId));
            return ChangeMonth(dt4.Month) + " " + dt4.Day + ", " + dt4.Year + "  " + dt4.DayOfWeek;
        }
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static string GetGuiGuTime(DateTime dt)
        {
            string Date = string.Empty;
            string TimeZoneId = "Pacific Standard Time";
            DateTime dt4 = TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId)).IsDaylightSavingTime() ? TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId)).AddHours(1) : TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId));
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static string GetXiErKeBaoDate(DateTime dt)
        {
            string Date = string.Empty;
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static string GetXiErKeBaoTime(DateTime dt)
        {
            string Date = string.Empty;
            string TimeZoneId = "Romance Standard Time";
            DateTime dt4 = TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId)).IsDaylightSavingTime() ? TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId)).AddHours(1) : TimeZoneInfo.ConvertTimeFromUtc(dt, TimeZoneInfo.FindSystemTimeZoneById(TimeZoneId));
        ...
        public static string JscriptMsg(string msgtitle, string url, string msgcss)
        {
            return "<script>parent.jsprint(\"" + msgtitle + "\", \"" + url + "\", \"" + msgcss + "\")</script> ";
        }
    }
}
