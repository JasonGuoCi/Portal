...
namespace Envision.SPS.Utility.Utilities
{
    public class IBRequest
    {
        ...
        //    string ts = string.Format(GetUrl("Key"), host, GetServerString("LOCAL_ADDR"), IBUtils.GetVersion());
        //    if (!string.IsNullOrEmpty(host) && host != "localhost")
        //    {
        //        IBUtils.GetDomainStr("dt_cache_domain_info", ts);
        //    }
        //    return host;
        //}
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !IBUtils.IsSafeSqlString(HttpContext.Current.Request.QueryString[strName]))
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !IBUtils.IsSafeSqlString(HttpContext.Current.Request.Form[strName]))
                return "unsafe string";
        ...
        {
            return IBUtils.StrToInt(HttpContext.Current.Request.QueryString[strName], 0);
        }
        ...
        /// <param name="strName">Url参数</param>
        /// <returns>Url参数的int类型值</returns>
        public static int GetFormQueryInt(string strName)
        {
            return IBUtils.StrToInt(HttpContext.Current.Request.Form[strName], 0);
        }
        ...
        /// <returns></returns>
        public static int GetMvcQuereyInt(string strName)
        {
            return IBUtils.StrToInt(strName, 0);
        }
        ...
        {
            return IBUtils.StrToInt(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return IBUtils.StrToInt(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        {
            return IBUtils.StrToDecimal(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return IBUtils.StrToDecimal(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        {
            return IBUtils.StrToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return IBUtils.StrToFloat(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        //    if (string.IsNullOrEmpty(result) || !IBUtils.IsIP(result))
        //        return "127.0.0.1";
        //    return result;
        //}
