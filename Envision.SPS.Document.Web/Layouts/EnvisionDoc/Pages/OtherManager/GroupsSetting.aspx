...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupsSetting.aspx.cs" Inherits="Envision.SPS.Document.Web.Layouts.EnvisionDoc.Pages.OtherManager.GroupsSetting" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="right" style="margin-left: 0px !important;">
                ...
                <div class="itmbox" style="padding: 0 40px 40px 40px !important;min-height:450px; margin-top: 0px !important;">
                    <div class="t_search" style="padding: 10px 10px 10px 10px !important;">
                        <a style="cursor: pointer;" class="add_dp" id="FaseAddGroups" runat="server">一键创建群组</a>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" class="tbox">
                        ...
                        <asp:Repeater ID="RepGroupsList" runat="server" OnItemDataBound="RepGroupsList_ItemDataBound">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:HyperLink ID="linkedit" runat="server" Text="编辑" style="cursor:pointer;" ToolTip='<%#DataBinder.Eval(Container.DataItem,"IsPermmsion")%>' onclick="envdoc.methods.editGroups(this)" CssClass="nor_link" pid='<%#DataBinder.Eval(Container.DataItem,"Id")%>' gname='<%#DataBinder.Eval(Container.DataItem,"Name")%>'></asp:HyperLink>
        ...
        <div id="AddGroups" class="tab-content">
            ...
            <%--<dl>
                <dt>群组所有者</dt>
                <dd>
                    <input id="txtGroupsOwner" name="txtGroupsOwner" readonly="readonly" datatype="*" class="input normal" />
